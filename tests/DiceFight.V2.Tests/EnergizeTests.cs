...
public class EnergizeTests
{
    ...
    private static readonly TriggeredAbility EnergizeAbility = new(
    ...
    private static CardDef BuildCard(string id) => new(
        ...
        Abilities: [EnergizeAbility], Continuous: []);
    ...
    private static bool Fired(GameState state, string cardId) =>
        state.Counters.GetValueOrDefault(("p1", cardId, "Fired")) > 0;
