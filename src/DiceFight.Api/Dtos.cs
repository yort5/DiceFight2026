...
public sealed record CardDefDto(
    ...
    string? Rarity, string? OldTeamBuilderCode, IReadOnlyList<string> AffiliationIcons,
    ...
    bool WhenFieldedNeedsTarget, string? Set)
{
    public static CardDefDto From(CardDef card)
    {
        ...
        return new(
            ...
            card.Affiliations, card.Alignment?.ToString(), card.Rarity, card.OldTeamBuilderCode,
            card.AffiliationIcons, card.DieLimit,
